  ...
  >
    ...
    <div class="flex flex-col sm:flex-row items-center justify-between gap-4 sm:h-48 mb-6">
      ...
      <div class="w-full sm:w-1/2 space-y-3 text-sm font-semibold text-gray-600 min-w-0">
        ...
        <div class="flex items-center gap-3">
          <span class="w-4 h-4 rounded-full bg-[#f0932b]"></span> Medio (31%)
        </div>
        <div class="flex items-center gap-3">
          <span class="w-4 h-4 rounded-full bg-[#7f76ff]"></span> Bajo (26%)
        </div>
        <div class="flex items-center gap-3">
          <span class="w-4 h-4 rounded-full bg-[#22a6b3]"></span> Muy bajo (16%)
        </div>
      </div>
    </div>
    <!-- mensaje de riesgo -->
